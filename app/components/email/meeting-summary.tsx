      ...
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          <Section style={headerStyle}>
            <Text style={headerTitleStyle}>📝 Meeting Summary Ready</Text>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={dateStyle}>
              Your meeting from {meetingDate} has been processed and is ready
              for review.
            </Text>
            ...
            <Section style={actionItemsContainerStyle}>
              <Text style={sectionTitleStyle}>✅ Action Items</Text>
              {actionItems.length > 0 ? (
                ...
                <Text style={noActionItemsStyle}>No action items recorded</Text>
              )}
            </Section>
          ...
          <Section style={footerStyle}>
            ...
            <Text style={footerTextStyle}>Need help? Contact support</Text>
          </Section>
        </Container>
      </Body>
    </Html>
